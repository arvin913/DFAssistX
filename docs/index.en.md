...
# Duty Finder / F.A.T.E Assist (DFAssistX)
**DFAssistX** is FFXIV Duty Finder / F.A.T.E assist software.
Do other things while in waiting list! DFAssistX will give you match notification.

## Information
- Latest Version ```v20170928.1``` ([Download](https://github.com/devunt/DFAssistX/releases/latest))
...
## Instructions
1. Download ``DFAssistX.v********.*.zip`` file from the upper download link's file list.
2. Extract archieve file wherever you want.
3. Execute ``DFAssistX.exe`` in the extracted folder.
...
## Problem Solving
Post problems on [Issue Tracker](https://github.com/devunt/DFAssistX/issues).
